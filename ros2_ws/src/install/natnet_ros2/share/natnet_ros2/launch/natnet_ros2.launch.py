...
def generate_launch_description():
    ...
    return  LaunchDescription([
        DeclareLaunchArgument('serverIP', default_value="100.86.116.1"),
        DeclareLaunchArgument('clientIP', default_value="100.96.124.69"),
        DeclareLaunchArgument('serverType', default_value="unicast"), # multicast/unicast
